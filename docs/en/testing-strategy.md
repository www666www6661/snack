...
| Protocol | partial frame, invalid JSON, duplicate ID, unknown event, request timeout, late response, shutdown reconnect, terminate/kill fallback, flood, process death |
